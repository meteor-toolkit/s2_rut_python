...
class TestS2RUT(unittest.TestCase):
    ...
    def test_run_rut_total_uncertainty(self, mock_unc_calculation, mock_interp, mock_get_band_unc_parameters):
        ...
        band_names = ["B01"]
        unc_info = "total"
        mock_interp.return_value = np.ones((5,5))
    ...
    @mock.patch('eoio.processors.utils.interp_sza_s2')
    def test_run_rut_invalid_unc_info(self, mock_interp_sza_s2):
        band_names = ["B01"]
        unc_info = "invalid"
