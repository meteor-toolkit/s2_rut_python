...
class S2RutAlgo:
    ...
    def __init__(self,
        ...
        self.alpha = alpha
        self.beta = beta
        self.u_diff_cos = u_diff_cos  # [%]from 0.13° diffuser planarity/micro as in (AIRBUS 2015). Assumed same for S2A/S2B.
        self.u_diff_k = u_diff_k  # [%] as a conservative residual (AIRBUS 2015). Assumed same for S2A/S2B.
        self.u_diff_temp = u_diff_temp  # This value is correctly redefined for specific satellite at the S2RutOp.
        self.u_ADC = u_ADC  # [DN](rectangular distribution, see combination)
        self.u_gamma = u_gamma
        self.k = k  # This value is correctly redefined for specific satellite at the S2RutOp.
        self.unc_select = [True, True, True, True, True, True, True, True, True, True, True,
                           True]  # list of booleans with user selected uncertainty sources(order as in interface)
